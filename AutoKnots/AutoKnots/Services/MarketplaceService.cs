...
public class MarketplaceService : IMarketplaceService
{
    ...
    public Task<MarketplacePage> SearchAsync(MarketplaceSearch search, CancellationToken cancellationToken = default) =>
        SearchCoreAsync(_db.VehicleListings.Where(x => x.Status == ListingStatus.Active), search, cancellationToken);
    ...
    public Task<MarketplaceListingDetails?> GetPublicDetailsAsync(int id, CancellationToken cancellationToken = default) =>
        GetDetailsAsync(id, query => query.Where(x => x.Status == ListingStatus.Active), cancellationToken);
        ...
        CancellationToken cancellationToken)
    {
        ...
        query = search.Sort.ToLowerInvariant() switch
        {
