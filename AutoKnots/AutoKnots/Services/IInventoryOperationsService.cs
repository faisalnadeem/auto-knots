...
public interface IInventoryOperationsService
{
    ...
    Task<(bool Success, string? Error, InventoryCost? Cost)> UpdateCostAsync(int inventoryItemId, int costId, UpdateCostRequest request, CancellationToken cancellationToken = default);
